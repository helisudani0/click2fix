...
export default function ActionsMin({ onExecutionCreated }) {
  ...
  const filteredActions = useMemo(() => {
    ...
    return actions.filter((action) => {
      ...
      if (catalogPlatform === "windows" && !platforms.includes("windows")) return false;
      if (catalogPlatform === "linux" && !platforms.includes("linux")) return false;
  ...
  }, [actions, catalogCategory, catalogPlatform, catalogSearch]);
      ...
      <div className="list">
        ...
        <div className="page-actions">
          <button className="btn" type="button" onClick={runSelectedAction} disabled={!canRun}>
            {dispatching ? "Queueing..." : "Run Action"}
          </button>
        </div>
